...
import { CoCircom, type ConfigurationParameters, JobApi, NodeApi, Configuration, BlueprintCurve, MpcProtocol, type Groth16Proof, type PublicSignals } from '@taceo/proof-client-bundler'
...
export default function CoCircomProve() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const jobId = await CoCircom.scheduleProveJob(jobInstance, nodes, blueprint, mpcProtocol, voucher, curve, numInputs, witness);
